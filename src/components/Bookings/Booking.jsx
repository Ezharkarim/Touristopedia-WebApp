    ...
    <div className="container">
      <div className="row">
          ...
          <div className="detailItem">
            <h2>
              We will Confirm your room booking via email with in 24 Hours
            </h2>
          </div>
          <h1>Booking Info..</h1>
          ...
          <div className="details" id="printablediv">
            ...
            <div className="detailItem">
              ...
              <span className="itemValue">Hotel room.</span>
            </div>
            ...
            <div className="detailItem">
              <span className="itemKey">RS:</span>
              <span className="itemValue">{user.price}</span>
            </div>
          ...
          <div className="row">
            <hr className="hr2" />
            <h3 className="itemKey1">
              Please Enter Your Booking Info and Submit.
            </h3>
            <form>
              <span className="itemKey">From Date :</span>
              <input
